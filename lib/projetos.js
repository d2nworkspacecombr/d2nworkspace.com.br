// lib/projetos.js
// GET    /api/projetos          -> lista projetos com % de progresso calculado (autenticado)
// POST   /api/projetos          -> cria projeto (autenticado; admin garantido pela RLS)
...
module.exports = async (req, res) => {
  ...
  if (req.method === "POST") {
    ...
    const { data, error } = await supabase
      .from("projetos")
      .insert({ nome: body.nome, cor: body.cor || "#22d3d3", criado_por: auth.usuarioId })
      .select()
      .single();
